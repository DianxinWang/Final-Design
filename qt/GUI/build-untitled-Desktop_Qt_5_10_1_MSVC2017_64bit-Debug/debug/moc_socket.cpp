...
QT_MOC_LITERAL(3, 21, 4), // "send"
QT_MOC_LITERAL(4, 26, 7), // "quint8*"
QT_MOC_LITERAL(5, 34, 4) // "data"

    },
    "socket\0dataRecieved\0\0send\0quint8*\0"
    "data"
};
...
void socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataRecieved(); break;
        case 1: _t->send((*reinterpret_cast< quint8*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
